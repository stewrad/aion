...
if __name__ == "__main__":
    ...
    # MODCOD_LOOKUP = { f"{mod}_{rate}": (mod, rate) for (mod, rate, _) in mcs_table }
    ...
    mcs_table = {f"{mod}_{rate}": 16200 for mod, rate, idx in mcs_table}
    ...
    frames, pad_lengths = pg.ldpc_bit_segmentation(bits, mcs_sequence, mcs_table)
