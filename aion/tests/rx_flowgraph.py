...
class rx_flowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "RX_stream", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RX_stream")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_flowgraph")
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:5555', 100, False, 1000000, '', False)
